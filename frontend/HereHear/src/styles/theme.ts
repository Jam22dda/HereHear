...
const shadow = {
    shadow_btn:
        "-2px -2px 6px 0px rgba(255, 255, 255, 0.40), 2px 2px 6px 0px #C4C4C4;",
    ...
    shadow_box3:
        "-10px -10px 20px 0px #E2E9FF inset, 10px 10px 20px 0px #BFCAE4 inset;",
    // shadow_album: "10px 15px 20px 10px #D1D1D1, -10px -7px 15px 10px #FFF;",
    shadow_album: "10px 15px 20px 5px #CBCCDC, -10px -7px 15px 10px #FFF;",
    shadow_goback: "4px 4px 8px 0px #D1D2F2, -4px -4px 8px 0px #F6F9FF;",
    shadow_smallbtn:
        "2px 2px 4px 0px #BAC3DF inset, -2px -2px 4px 0px #FFF inset;",
    shadow_heart:
        "-1px -1px 2px 0px #EDF2FF inset, 2px 2px 4px 0px #C2CDEF inset;",
...
const gradient = {
    gradient1:
        "linear-gradient(180deg, rgba(231, 238, 255, 0.70) 0%, rgba(224, 234, 255, 0.70) 99.99%, rgba(224, 234, 255, 0.00) 100%)",
