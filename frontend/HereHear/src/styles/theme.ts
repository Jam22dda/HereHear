...
const gradient = {
  ...
  angular: "conic-gradient(from 135deg at 79.6% -13.32%, rgba(98, 132, 255, 0.30) 0deg, rgba(255, 150, 200, 0.30) 47.61769652366638deg, rgba(249, 229, 232, 0.30) 99.69967246055603deg, rgba(169, 212, 255, 0.30) 186.6353988647461deg, rgba(251, 183, 212, 0.30) 234.49278831481934deg)"
};
