...
public class SpotifyUser extends OAuth2ProviderUser {

    public SpotifyUser(Attributes attributes, OAuth2User oAuth2User, ClientRegistration clientRegistration) {
